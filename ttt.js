...
$(document).ready(function(){
    ...
    var turn = $('.turn'); // select the id #whos_turn from html (an element) - see html
    ...
    function click(){
        ...
        turn.text('player ' + (current + 1)); // note: setting text like this overrides any previous values, it does not append.
    ...
    function markRow(row){
        ...
        turn.text(""); // game is over. no more turns. Clear this text in the html by setting it blank.
    ...
    function reset(){
        ...
        turn.text('player ' + (current +1)); // communicate which players turn it is.
